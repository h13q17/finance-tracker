          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-6">
              ...
              <p className="max-w-[800px] text-md sm:text-xl text-muted-foreground text-center">
                Fintrack is a powerful finance tracking app that helps you
                manage your money with ease. Track your income, expenses, and
                savings, and get personalized insights to reach your financial
                goals.
              </p>
